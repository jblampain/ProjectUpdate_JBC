...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([transforms.Resize(256),  # Resize to 256x256
    transforms.RandomCrop(224),  # Random crop to 224x224
    # Augmentation
    transforms.RandomHorizontalFlip(p=0.3),  # Randomly flip horizontally
    ...
    transforms.Normalize(mean,std),  # Normalize pixel values
        ...
        "valid": transforms.Compose([transforms.Resize(256),  # Resize to 256x256
    transforms.CenterCrop(224),  # Center crop to 224x224
    transforms.ToTensor(),  # Convert to tensor
    transforms.Normalize(mean,std),  # Normalize pixel values

        ]),
        "test": transforms.Compose([transforms.Resize(256),  # Resize to 256x256
    transforms.CenterCrop(224),  # Center crop to 224x224
    transforms.ToTensor(),  # Convert to tensor
    transforms.Normalize(mean,std),  # Normalize pixel values
